 ...
 * Copyright 2021 Emmanuel William
 * Theme core scripts
 *
...
(function () {
  ...
  var carousel = (function () {
    ...
    forEach(carousels, function (index, value) {
      ...
      if (
        value.dataset.carouselOptions != undefined &&
        JSON.parse(value.dataset.carouselOptions).axis === "vertical"
      ) {
        controlsText = [
      ...
      var carouselWrapper = value.closest(".tns-carousel-wrapper"),
        ...
        carouselCurrentSlide =
          carouselWrapper.querySelector(".tns-current-slide"),
        carouselTotalSlides =
          carouselWrapper.querySelector(".tns-total-slides"); // Center slide
  ...
  var lightbox = (function () {
    var lightboxToogle = document.querySelectorAll(
    ...
    var _loop5 = function _loop5(i) {
      ...
      if (mapOptions && mapOptions !== "") {
        var mapOptionsObj = JSON.parse(mapOptions),
          ...
          mapCoordinates = mapOptionsObj.coordinates
            ? mapOptionsObj.coordinates
            : [0, 0],
  ...
  var bindedInputValue = (function () {
    ...
    var _loop6 = function _loop6(i) {
      var bindedElement = document.querySelector(
          bindedInput[i].dataset.bsBindedElement
        ),
        ...
        if (this.checked) {
          for (var n = 0; n < targetCheckboxes.length; n++) {
            ...
            if (targetCheckboxes[n].dataset.checkboxToggleClass) {
              document
                .querySelector(targetCheckboxes[n].dataset.bsTarget)
          ...
          for (var m = 0; m < targetCheckboxes.length; m++) {
            ...
            if (targetCheckboxes[m].dataset.checkboxToggleClass) {
              document
                .querySelector(targetCheckboxes[m].dataset.bsTarget)
                .classList.remove(
